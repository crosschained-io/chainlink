...
before(async () => {
  ...
  operatorFactory = await ethers.getContractFactory("src/v0.7/Operator.sol:Operator");
  forwarderFactory = await ethers.getContractFactory("src/v0.7/AuthorizedForwarder.sol:AuthorizedForwarder");
